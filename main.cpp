    ...
    for(int i = 0; i < SIZE; i++)
    {
        ...
        switch(type)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                cout << " " << array[i]->get_class_name() << ": собрали с грядки " << endl;
                array[i]->pick();
                break;  
        }
    }
...
void choose(seedbed ** array) // функция вызова уникальных методов объектов классовzz
{
    int menu, i;
